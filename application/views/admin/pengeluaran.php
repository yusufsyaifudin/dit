...
<html>
	...
	<?php else: ?>
     	...
     	<div class="container">
		<?php  echo form_open('admin/tambah_pengeluaran') . "\n"; ?>
		<table>
			<tr>
				<td>Keterangan*</td>
			...
			<tr>
				...
				<td>
					<select name="kebutuhan">
						<option value="primer" selected="selected">Primer</option>
			...
			<tr>
				<td>Catatan</td>
				<td><input type="text" name="catatan" placeholder="Misal: tujuan penggunaan dana, dll"></td>
			</tr>
			<tr>
				<td></td>
